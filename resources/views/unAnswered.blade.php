                                    ...
                                    <div style="padding:0px;" class="card-body">
                                        <div style="padding:0px;" class="timeline-item-header">
                                            ...
                                            <img src="/storage/photo/{{ App\Models\User::where('id', $ans->add_User_id)->first()['photo']; }}" class="avatar"
                                                alt="Avatar">
                                            {{-- @else
                                            <img src="/storage/photo/user.png" class="avatar" alt="Avatar">
                                            @endif --}}
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                        <div class="modal-content ">
                            <div class="modal-header"
                                ...
                                <h5 class="modal-title" id="exampleModalLongTitle" style="color: black;"> Add Answer
                                </h5>
                                <button type="button" style="outline: none;" class="close" data-dismiss="modal"
                                    aria-label="Close">
                                    <span aria-hidden="t url('/') }}/addAnssrue">&times;</span>
                                </button>
                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            <div class="col-form-label">
                                                <label id="message-text" for="message-text"></label>
