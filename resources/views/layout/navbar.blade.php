            ...
            <form action="{{ route('search') }}" method="GET" class="navbar-form form-inline">
                <div class="input-group search-box">
                    <input type="text" id="search" autocomplete="off" class="form-control"
                        placeholder="Search your Query..." name="search">
                    <span class="input-group-addon"><i class="material-icons">&#xE8B6;</i></span>
                </div>
            </form>
            <div class="navbar-nav ml-auto">
                <a href="{{ url('dashboard') }}" class="nav-item "><i
                        class="fa fa-home"></i><span>Home</span></a>
                <a href="{{ route('unAnswered') }}" class="nav-item "><i
                        class="fa fa-pencil"></i><span>Add Answer</span></a>
                @if (Session::has('loginID'))
                    <a href="" data-toggle="modal" data-target="#exampleModalCenter" class="nav-item "><i
                            class="fa fa-pie-chart"></i><span>Ask Question</span></a>
                @else
                ...
                <div class="nav-item dropdown">
                    ...
                    @if (Session::has('loginID'))
                        <a href="#" data-toggle="dropdown" class="nav-item nav-link dropdown-toggle user-action">
                            ...
                            @if (Session::get('userDetails')['photo'] == 'https://t4.ftcdn.net/jpg/02/15/84/43/240_F_215844325_ttX9YiIIyeaR7Ne6EaLLjMAmy4GvPC69.jpg')
                                <img src="{{url('/')}}/{{ Session::get('userDetails')['photo'] }}" class="avatar"
                                    alt="Avatar">
                            @else
                                <img src="storage/photo/{{ Session::get('userDetails')['photo'] }}"
                    ...
                    @else
                        <a href="#" data-toggle="dropdown" class="nav-item nav-link dropdown-toggle user-action"><img
                                src="https://img.icons8.com/bubbles/50/000000/user.png" class="avatar"
                                alt="Avatar">

                            User</a>
                        <div class="dropdown-menu">

                            <a href="{{ URL::to('/login') }}" class="dropdown-item"><i
                                    class="material-icons">&#xE8AC;</i> Login</a>
                        </div>
                    @endif
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="modal-form" action="{{ url('/') }}/data" name="myForm"
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group" id="xyz">
                                ...
                                <textarea class="form-control" name="des" placeholder="Start your Question with ' What ',' How ',' Why ' ect."
                                    id="desc"></textarea>
