<nav class="navbar navbar-expand-xl navbar-dark bg-dark sticky-top">
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
        ...
        <div class="navbar-nav ml-auto">
            <a href="{{ URL::to('/') }}" class="nav-item "><i class="fa fa-home"></i><span>Home</span></a>
            ...
            <div class="nav-item dropdown" style="width: auto;">
                ...
                {{-- @else --}}
                @if(Session::has('user'))
                <a href="#" data-toggle="dropdown" class="nav-item nav-link dropdown-toggle user-action" style="margin-right:50px" aria-expanded="true"><img
                        src="storage/photo/{{ Session::get('user')['photo'] }}" class="avatar" alt="Avatar" style="border-radius: 40%">
                 <span style="color: rgb(39, 35, 35)">{{  Session::get('user')['name'] }}</span> </a>
                 @else
                 <a href="#" data-toggle="dropdown" class="nav-item nav-link dropdown-toggle user-action" style="margin-right:50px" aria-expanded="true"><img
                    src="https://img.icons8.com/bubbles/50/000000/user.png" class="avatar" alt="Avatar">
