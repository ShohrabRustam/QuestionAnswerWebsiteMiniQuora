        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            {{-- <div class="px-4 py-3">
                ...
                <div class="p-4 rounded shadow-sm bg-light">
                    ...
                    <p class="font-italic mb-0">{{$answer->add_answer}}</p>
                    @endforeach
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/profile/data" name="data" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <input type="hidden" name="id" value="{{ $data->id }}" class="form-control">
                        <label for="recipient-name" class="col-form-label">Name:</label>
                        <input type="text" name="name" value="{{ $data->name }}" class="form-control" id="user_name">
                        <div style="color:red;" id="name_error"></div>
                    </div>
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Email:</label>
                        <input type="text" name="email" value="{{ $data->email }}" class="form-control" id="user_email">
