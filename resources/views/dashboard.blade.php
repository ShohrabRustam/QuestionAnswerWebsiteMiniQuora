            ...
            <div class="row text-left mb-5">
                <div class="col-lg-6 mb-3 mb-sm-0">
                    <div class="dropdown bootstrap-select form-control form-control-lg bg-white bg-op-9 text-sm w-lg-50"
                        style="width: 100%;">
                        <select id="selectCat" onchange="getThisCat()"
                            class="form-control form-control-lg bg-white bg-op-9 text-sm w-lg-50" data-toggle="select"
                            tabindex="-98">
                ...
                <div style="padding-top: 0rem !important; padding-bottom: 0rem !important;"
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8 mb-3 mb-sm-0">
                            <h5>
                                <a href="{{ url('/question/' . $ques->que_id . '/' . $ques->slug) }}"
                                    class="text-primary" style="text-decoration: none;">{{ $ques->add_question }}</a>
                            </h5>
                            <p class="text-sm"><span class="op-6">Asked</span> <a class="text-black" href="#">{{
                                    $ques->created_at->diffForHumans() }}</a>
                        ...
                        <div class="col-md-4 op-7">
                            <div class="row text-center op-7">
                                ...
                                <div class="col px-1"> <i class="ion-ios-eye-outline icon-1x"></i> <span
                                        class="d-block text-sm">{{ App\Models\Question::getTotalCount($ques->que_id) }}
                                        Views</span> </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white mb-3">
                        ...
                        <div class="pos-relative px-3 py-3">
                            <h6 class="text-primary text-sm">
                                <a href="#" class="text-primary">{{ $topQue->add_question }}</a>
                            </h6>
                            <p class="mb-0 text-sm"><span class="op-6">Posted</span> <a class="text-black"
                                    href="#">{{$topQue->created_at->diffForHumans()}}</a> <span class="op-6">ago
                    ...
                    <div class="bg-white text-sm">
                        ...
                        <div class="row text-center d-flex flex-row op-7 mx-0">
                            <div class="col-sm-6 flex-ew text-center py-3 border-bottom border-right"> <a
                                    class="d-block lead font-weight-bold" href="#">{{ App\Models\Category::count()
                                    }}</a> Topics </div>
                            <div class="col-sm-6 col flex-ew text-center py-3 border-bottom mx-0"> <a
                                    class="d-block lead font-weight-bold" href="#">{{ App\Models\Question::count()
                                    }}</a> Questions </div>
                        </div>
                        <div class="row d-flex flex-row op-7">
                            ...
                            <div class="col-sm-6 flex-ew text-center py-3 mx-0"> <a
                                    class="d-block lead font-weight-bold" href="#">
                                    @if(App\Models\User::latest()->first())
